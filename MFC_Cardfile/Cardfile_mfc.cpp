...
// Cardfile_mfc.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CCardfilemfcApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CCardfilemfcApp

CCardfilemfcApp::CCardfilemfcApp()
{
...
// Единственный объект CCardfilemfcApp

CCardfilemfcApp theApp;


// Инициализация CCardfilemfcApp

BOOL CCardfilemfcApp::InitInstance()
{
